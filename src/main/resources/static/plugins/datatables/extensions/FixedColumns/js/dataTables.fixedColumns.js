...
FixedColumns.prototype = /** @lends FixedColumns.prototype */{
	 ...
	 *      var fc = new $.fn.dataTable.fixedColumns( table );
	 *
	 *      // Resize the table container and then have FixedColumns adjust its base....
	 *      $('#content').width( 1200 );
	 *      fc.fnRedrawLayout();
	 */
	...
	"_fnConstruct": function ( oInit )
	{
		...
		/* Set up the DOM that we want for the fixed column base grid */
		this._fnColCalc();
		this._fnGridSetup();
	...
	/**
	 * Calculate the column widths for the grid base
	 *  @returns {void}
	 *  @private
	 */
	"_fnColCalc": function ()
	...
	/**
	 * Set up the DOM for the fixed column. The way the base works is to create a 1x3 grid
	...
	/**
	 * Style and position the grid used for the FixedColumns base
	 *  @returns {void}
	 *  @private
	 */
	...
	/**
	 * Make a copy of the base object for a header or footer element from DataTables. Note that
	 * this method will clone the nodes in the base object.
	 *  @returns {Array} Copy of the base array
	...
	"_fnClone": function ( oClone, oGrid, aiColumns, bAll )
	{
		...
		if ( bAll )
		{
			...
			/* Copy the DataTables base cache for the header for our floating column */
		...
		else
		{
			 ...
			 * cloned cells, just copy the classes across. To get the matching base for the

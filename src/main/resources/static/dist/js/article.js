...
function articleEdit() {
    ...
    //请求数据
    $.get("fly/articles/info/" + id, function (r) {
...
function search() {
    ...
    //提交post并刷新表格
    $("#jqGrid").jqGrid("setGridParam", {url: 'fly/articles/search'}).trigger("reloadGrid");
